...
>
  ...
  <path fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
   d="M12.5 10a2.5 2.5 0 110 5 2.5 2.5 0 010-5zm5.5 2.5c0-.394-.052-.775-.15-1.14l1.595-1.24a.5.5 0 00.125-.63l-1.548-2.682a.5.5 0 00-.604-.23l-1.93.774a5.966 5.966 0 00-1.38-.796l-.267-1.885a.5.5 0 00-.493-.396h-3.395a.5.5 0 00-.493.395l-.266 1.886a5.973 5.973 0 00-1.38.796l-1.93-.775a.5.5 0 00-.604.231L3.43 9.49a.5.5 0 00.125.63l1.595 1.24a6.013 6.013 0 000 2.28l-1.595 1.24a.5.5 0 00-.125.63l1.548 2.683a.5.5 0 00.604.23l1.93-.774a5.973 5.973 0 001.38.796l.267 1.885a.5.5 0 00.493.396h3.395a.5.5 0 00.493-.395l.266-1.886a5.966 5.966 0 001.38-.796l1.93.775a.5.5 0 00.604-.231l1.548-2.682a.5.5 0 00-.125-.63l-1.595-1.24c.098-.365.15-.746.15-1.14zM8.5 7a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm0 2c.4 0 .78.052 1.14.15l1.24-1.595a.5.5 0 01.63-.125l2.682 1.548a.5.5 0 01.23.604l-.774 1.93c.292.426.566.878.796 1.38l1.885.267a.5.5 0 01.396.493v3.395a.5.5 0 01-.395.493l-1.886.266a5.973 5.973 0 01-.796 1.38l.775 1.93a.5.5 0 01-.231.604l-2.682 1.548a.5.5 0 01-.63-.125l-1.24-1.595A6.013 6.013 0 018.5 22a6.013 6.013 0 01-2.28-.495l-1.24 1.595a.5.5 0 01-.63.125l-2.683-1.548a.5.5 0 01-.23-.604l.774-1.93a5.973 5.973 0 01-.796-1.38l-1.885-.267a.5.5 0 01-.396-.493v-3.395a.5.5 0 01.395-.493l1.886-.266a5.966 5.966 0 01.796-1.38l-.775-1.93a.5.5 0 01.231-.604l2.682-1.548a.5.5 0 01.63.125l1.24 1.595c.365-.098.746-.15 1.14-.15z"/></svg>
  ...
  <div class="container mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div class="space-y-4">
      <a href="{{ route('home') }}" class="inline-block">
        <img src="{{ asset('images/ChatGPT Image 2 يوليو 2025، 12_55_08 م.png') }}" alt="{{ __('messages.site_name') }}" class="h-20 dark:hidden">
        <img src="{{ asset('images/WhatsApp_Image_2025-07-01_at_9.33.32_PM-removebg-preview.png') }}" alt="{{ __('messages.site_name') }}" class="h-20 hidden dark:inline-block">
      </a>
      <p class="text-sm">
