...
<a href="https://wa.me/{{ config('services.whatsapp.number') }}?text={{ urlencode($invoice) }}"           target="_blank"
           class="inline-flex items-center space-x-4 rtl:space-x-reverse px-6 py-3 bg-green-500 text-white font-semibold rounded-full shadow-lg hover:bg-green-600 transition">
          <span>{{ __('messages.Contact via WhatsApp') }}</span>
