...
<nav id="navbar"
  ...
  <div class="max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center justify-between">
    ...
    <a href="{{ route('home') }}" class="flex items-center space-x-2 hover:scale-105 transition-transform duration-200">
      <img src="/images/ChatGPT Image 2 يوليو 2025، 12_55_08 م.png" alt="Logo" class="h-12 w-12 block dark:hidden">
      <img src="/images/logo-dark.png" alt="Logo Dark" class="h-12 w-12 hidden dark:block">
